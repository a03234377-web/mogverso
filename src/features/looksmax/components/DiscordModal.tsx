...
import { Modal, ModalCloseButton } from "@/features/looksmax/components/ui/Modal";
...
export function DiscordModal({ open, onClose }: DiscordModalProps) {
  return (
    <Modal open={open} onClose={onClose} id="modalUnirse" labelledBy="discord-modal-title">
...
export function DiscordModalContent() {
  return (
    <>
      <div className="animate-modal-crown mb-2.5 flex justify-center" aria-hidden>
        <Icon name="crown" size={44} className="text-lm-gold" />
      </div>
      <div
        id="discord-modal-title"
        className="font-display mb-1 text-center text-[clamp(1.5rem,5vw,2.4rem)] leading-tight tracking-[3px] bg-[linear-gradient(135deg,#fff,var(--color-lm-gold2)_50%,var(--color-lm-gold)_100%)] bg-clip-text text-transparent max-md:text-[clamp(1.8rem,5vw,2.6rem)]"
      >
        Únete a la
        <br />
        Comunidad
      ...
      <div className="mb-6 flex flex-col gap-3">
        <div className="flex items-start gap-3 rounded-xl border border-[rgba(232,184,75,0.12)] bg-[rgba(232,184,75,0.05)] px-3.5 py-3">
          <Icon name="trophy" size={22} className="mt-0.5 shrink-0 text-lm-gold" aria-hidden />
          <div>
        ...
        <div className="flex items-start gap-3 rounded-xl border border-[rgba(232,184,75,0.12)] bg-[rgba(232,184,75,0.05)] px-3.5 py-3">
          <Icon name="vote" size={22} className="mt-0.5 shrink-0 text-lm-gold" aria-hidden />
          <div>
            <strong className="mb-0.5 block text-[0.82rem] font-extrabold text-lm-text">
        ...
        <div className="flex items-start gap-3 rounded-xl border border-[rgba(232,184,75,0.12)] bg-[rgba(232,184,75,0.05)] px-3.5 py-3">
          <Icon name="zap" size={22} className="mt-0.5 shrink-0 text-lm-gold" aria-hidden />
          <div>
            <strong className="mb-0.5 block text-[0.82rem] font-extrabold text-lm-text">
      ...
      <div className="rounded-[14px] border border-[rgba(88,101,242,0.4)] bg-[linear-gradient(135deg,rgba(88,101,242,0.15),rgba(88,101,242,0.05))] px-4 py-4 text-center">
        <div className="mb-1 flex items-center justify-center gap-1.5 text-[0.62rem] font-extrabold uppercase tracking-[1.5px] text-[#7289da]">
          <Icon name="message-circle" size={14} />
          Únete a nuestro servidor de Discord
        </div>
        <a
          className="lm-focus-ring mt-1.5 inline-flex items-center gap-2 rounded-[10px] border-none bg-[linear-gradient(135deg,#5865f2,#7289da)] px-5 py-2.5 font-sans text-[0.9rem] font-extrabold tracking-wide text-white no-underline transition-all duration-250 hover:scale-[1.04] hover:shadow-[0_0_20px_rgba(88,101,242,0.4)] max-md:min-h-12 max-md:px-5 max-md:py-3 max-md:text-[0.95rem]"

...
export function AuraPage({
  ...
  return (
    <div id="page-aura" className="block animate-fade-up">
      ...
      <ScrollReveal y={36} className="mx-auto mb-6 max-w-[1100px] px-5 max-md:px-4">
        <AuraLeadersGrid
          ready={leadersReady}
          className={cn("grid grid-cols-2 gap-3", "max-md:grid-cols-1 max-md:gap-2.5")}
        >
          <AuraLeadersCard
            title="Más Aura"

...
import { performHealTorneo } from "@/lib/firebase/perform";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await performHealTorneo(ip, {
      restartIfEnded: body.restartIfEnded === true,
    });
    ...
    console.error("[api/heal/torneo]", err);
